...
MARKET_NAME = "asian_handicap_big_home_underdog_home"

# Positive home AH line means the home team is the handicap underdog.
# Example: AHh = +1.25 means Home +1.25 / Away -1.25.
...
def summarize(dataframe):
    ...
    return {
        ...
        "avg_odds": float(dataframe["home_ah_odds"].mean()),
...
def prepare_data(league_code, variant_name):
    ...
    # Neste mercado apostamos diretamente no Home AH.
    # Exemplo: AHh = +1.25 significa apostar Home +1.25.
    dataframe["home_handicap"] = dataframe["ah_line"]
    ...
    dataframe["bet_side"] = "Home AH vs big away favourite"
...
def run_variant(args, variant_name):
    ...
    print("Regra testada: Home AH quando AHh >= threshold")
