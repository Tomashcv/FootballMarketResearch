...
ALPHA_VALUES = [0.0, 0.10, 0.20, 0.35, 0.50, 0.75]
MAX_DEPTH_VALUES = [1, 2]
LEARNING_RATE_VALUES = [0.03]
NUM_BOOST_ROUND_VALUES = [80]
LAMBDA_VALUES = [10.0, 25.0, 50.0]


FEATURE_SETS = {
    "xgb_current_season_strength": [
        "market_home_probability",
        "market_draw_probability",
        "market_away_probability",
        "market_home_away_probability_gap",
        "market_favorite_probability",
        "market_underdog_probability",
        "market_draw_to_favorite_ratio",
        "market_draw_to_home_away_gap_ratio",

        "home_current_season_matches_before",
        "away_current_season_matches_before",
        "min_team_matches_this_season_before",

        "home_current_season_points_per_game_before",
        "away_current_season_points_per_game_before",
        "current_season_points_per_game_diff",
        "current_season_points_per_game_abs_diff",

        "home_current_season_goal_diff_per_game_before",
        "away_current_season_goal_diff_per_game_before",
        "current_season_goal_diff_per_game_diff",
        "current_season_goal_diff_per_game_abs_diff",

        "home_current_season_goals_for_per_game_before",
        "away_current_season_goals_for_per_game_before",
        "home_current_season_goals_against_per_game_before",
        "away_current_season_goals_against_per_game_before",
        "current_season_goals_for_per_game_abs_diff",
        "current_season_goals_against_per_game_abs_diff",

        "home_current_season_draw_rate_before",
        "away_current_season_draw_rate_before",
        "current_season_draw_rate_average",
        "current_season_draw_rate_abs_diff",

        "home_away_context_current_season_points_per_game_abs_diff",
        "home_away_context_current_season_goal_diff_per_game_abs_diff",
        "home_away_context_current_season_draw_rate_average",
        "home_away_context_current_season_draw_rate_abs_diff",
    ],

    "xgb_current_season_plus_strength_balance": [
        "market_home_probability",
        "market_draw_probability",
        "market_away_probability",
        "market_home_away_probability_gap",
        ...
        "overall_goals_for_last_5_abs_diff",
        "overall_goals_against_last_5_abs_diff",
        "overall_goal_difference_abs_last_5_average",
        "home_away_context_goals_for_last_5_abs_diff",
        "home_away_context_goals_against_last_5_abs_diff",
        "home_away_context_goal_difference_abs_last_5_average",
        "expected_goal_gap_simple_5",
        "combined_context_goal_gap_abs_5",
    ],

    "xgb_market_shape_only": [
        "market_home_probability",
        "market_draw_probability",
        "market_away_probability",
        "market_not_draw_probability",
        "market_home_minus_away_probability",
        "market_home_away_probability_gap",
        "market_favorite_probability",
        "market_underdog_probability",
        "market_draw_minus_league_draw_rate",
        "market_draw_minus_0_25",
        "market_draw_to_favorite_ratio",
        "market_draw_to_home_away_gap_ratio",
        "league_draw_rate_so_far",
        "league_avg_goals_so_far",
    ],

    "xgb_draw_form_5": [
        "home_overall_draw_rate_last_5",
        "away_overall_draw_rate_last_5",
        "home_home_draw_rate_last_5",
        "away_away_draw_rate_last_5",
        "overall_draw_rate_last_5_diff",
        "overall_draw_rate_last_5_abs_diff",
        "overall_draw_rate_last_5_average",
        "home_away_context_draw_rate_last_5_diff",
        "home_away_context_draw_rate_last_5_abs_diff",
        "home_away_context_draw_rate_last_5_average",
        "combined_context_draw_rate_5",
        "market_home_away_probability_gap",
        "market_favorite_probability",
        "market_draw_to_favorite_ratio",
        "market_draw_to_home_away_gap_ratio",
    ...
    "xgb_low_goal_balance_5": [
        "home_overall_under_25_rate_last_5",
        "away_overall_under_25_rate_last_5",
        "home_home_under_25_rate_last_5",
        "away_away_under_25_rate_last_5",
        "home_overall_low_goals_rate_last_5",
        "away_overall_low_goals_rate_last_5",
        "home_home_low_goals_rate_last_5",
        "away_away_low_goals_rate_last_5",
        "combined_context_under_25_rate_5",
        "combined_context_low_goals_rate_5",
        ...
        "market_draw_probability",
        "league_avg_goals_so_far",
        "league_low_goals_rate_so_far",
    ],

    "xgb_strength_balance_5": [
        "home_overall_goals_for_last_5",
        "home_overall_goals_against_last_5",
        "away_overall_goals_for_last_5",
        "away_overall_goals_against_last_5",
    ...
    "xgb_full_draw_v1": [
        ...
        "home_overall_goal_difference_abs_last_5",
        "away_overall_goal_difference_abs_last_5",
        "home_home_goal_difference_abs_last_5",
        "away_away_goal_difference_abs_last_5",
        "overall_goal_difference_abs_last_5_average",
        "home_away_context_goal_difference_abs_last_5_average",
        "combined_context_goal_gap_abs_5",

        "home_overall_draw_rate_last_10",
        "away_overall_draw_rate_last_10",
        "home_home_draw_rate_last_10",
        "away_away_draw_rate_last_10",
        "combined_context_draw_rate_10",
        "expected_total_goals_simple_10",
        "expected_goal_gap_simple_10",
        "combined_context_under_25_rate_10",
        "combined_context_low_goals_rate_10",
        ...
        "league_avg_goals_so_far",
        "league_draw_rate_so_far",
        "league_under_25_rate_so_far",
        "league_low_goals_rate_so_far",
        "league_both_score_rate_so_far",
...
def add_market_logit(dataframe):
    dataframe["market_probability_draw"] = dataframe["market_probability_draw"].apply(clip_probability)
    dataframe["market_logit_draw"] = dataframe["market_probability_draw"].apply(probability_to_logit)
...
def train_xgboost_base_margin(
    ...
    y_train = train_dataframe["target_draw"].astype(int)

    x_test = test_dataframe[feature_columns].astype(float)

    train_base_margin = train_dataframe["market_logit_draw"].astype(float).values
    test_base_margin = test_dataframe["market_logit_draw"].astype(float).values
...
def predict_candidate(
    ...
    market_probabilities = test_dataframe["market_probability_draw"].astype(float).values
...
def evaluate_probabilities(dataframe, probabilities):
    y_true = dataframe["target_draw"].astype(int).values
    market_probabilities = dataframe["market_probability_draw"].astype(float).values
...
def evaluate_candidate_on_validation(dataframe, candidate, validation_year):
    ...
    if train_dataframe["target_draw"].nunique() < 2:
        return None
...
def evaluate_test_year(dataframe, test_year, selected_candidate):
    ...
    predictions_dataframe["model_probability_draw"] = probabilities
    predictions_dataframe["model_probability_not_draw"] = 1.0 - predictions_dataframe["model_probability_draw"]
...
def print_overall_results(by_year_dataframe):
    ...
    print("")
    print("=== DRAW XGBOOST MARKET-MARGIN OVERALL ===")
...
def main():
    ...
    parser.add_argument("--min-validation-improvement", type=float, default=0.00015)
    ...
    dataframe = dataframe.dropna(
        subset=["season_end_year", "target_draw", "market_probability_draw", "market_logit_draw"]
    ).copy()

    dataframe["season_end_year"] = dataframe["season_end_year"].astype(int)
    dataframe["target_draw"] = dataframe["target_draw"].astype(int)
    ...
    for test_year in years:
        ...
        print("")
        print(f"=== DRAW XGBOOST MARKET-MARGIN BEFORE TEST YEAR {test_year} ===")
    ...
    if len(by_year_results) == 0:
        raise ValueError("Não houve anos suficientes para Draw XGBoost market-margin.")
    ...
    print("")
    print("=== DRAW XGBOOST MARKET-MARGIN BY YEAR ===")
